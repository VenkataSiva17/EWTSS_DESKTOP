...
//            }
//            else if (nodeText.Equals("RADAREMITTERALLIED", StringComparison.OrdinalIgnoreCase))
//            {
//                ShowEmptyForm();
//            }
...
//            }
//            else if (nodeText.Equals("COMEMITTER", StringComparison.OrdinalIgnoreCase))
//            {
//                ShowEmptyForm();
//            }
...
//            }
//            else if (nodeText.Equals("RADAR", StringComparison.OrdinalIgnoreCase))
//            {
//                ShowEmptyForm();
//            }
...
//            RadarEmitterTechnicalTabButton.Background =
//                (System.Windows.Media.Brush)new BrushConverter().ConvertFromString("#2CB7B0");
//            RadarEmitterTacticalTabButton.Background =
//                (System.Windows.Media.Brush)new BrushConverter().ConvertFromString("#179C96");
//        }
...
//        private void ShowRadarEmitterAlliedPropertiesForm(string emitterName)
//        {
//            HideAllForms();
...
//            RadarEmitterAlliedTitleTextBlock.Text = $"{emitterName} PROPERTIES";
...
//            }
//        }
//        private void ShowCommEmitterTechnicalTab2()
//        {
...
//        private void ShowCommEmitterTacticalTab2()
//        {
...
//        {
//            ShowCommEmitterTechnicalTab2();
//        }

//        private void CommEmitterTacticalTabButton2_Click(object sender, RoutedEventArgs e)
//        {
//            ShowCommEmitterTacticalTab2();
//        }

//        private void ShowCommEmitterPropertiesForm(string emitterName)
//        {
//            HideAllForms();
//            CommEmitterPropertiesBorder.Visibility = Visibility.Visible;
//            DrsTableBorder.Visibility = Visibility.Visible;

//            CommEmitterTitleTextBlock.Text = $"{emitterName} PROPERTIES";
//            CommEmitterNameTextBox2.Text = emitterName;

//            ShowCommEmitterTechnicalTab2();
//        }

//        private void ShowRadarTechnicalTab2()
//        {
...
//        private void ShowRadarTacticalTab2()
//        {
...
//        {
//            ShowRadarTechnicalTab2();
//        }

//        private void RadarTacticalTabButton2_Click(object sender, RoutedEventArgs e)
//        {
//            ShowRadarTacticalTab2();
//        }

//        private void ShowRadarPropertiesForm(string radarName)
//        {
//            HideAllForms();
//            RadarPropertiesBorder.Visibility = Visibility.Visible;
//            DrsTableBorder.Visibility = Visibility.Visible;

//            RadarTitleTextBlock.Text = $"{radarName} PROPERTIES";
//            RadarNameTextBox2.Text = radarName;
...
//                int redLineId = db.ScenarioLines
//                    .Where(x => x.AreaOperation.ScenarioId == _scenarioId && x.Name == "RED LINE")
//                    .Select(x => x.Id)
//                    .FirstOrDefault();

//                if (redLineId <= 0)
//                {
//                    MessageBox.Show("RED LINE not found for this scenario.");
//                    return;
//                }

//                double? power = null;
//                if (double.TryParse(CommEmitterPowerTextBox2.Text, out double parsedPower))
//                    power = parsedPower;

//                double? frequency = null;
//                if (double.TryParse(CommEmitterFrequencyTextBox2.Text, out double parsedFrequency))
//                    frequency = parsedFrequency;

//                double? bandwidth = null;
//                if (double.TryParse(CommEmitterBandwidthTextBox2.Text, out double parsedBandwidth))
//                    bandwidth = parsedBandwidth;

//                double? gain = null;
//                if (double.TryParse(CommEmitterGainTextBox2.Text, out double parsedGain))
//                    gain = parsedGain;

//                double? scanRate = null;
//                if (double.TryParse(CommEmitterScanRateTextBox2.Text, out double parsedScanRate))
//                    scanRate = parsedScanRate;

//                Emitter emitter;
//                bool isUpdate = false;

//                if (_selectedCommEmitterId.HasValue)
//                {
//                    emitter = db.Emitters.FirstOrDefault(x => x.Id == _selectedCommEmitterId.Value);
//                    if (emitter == null)
//                    {
//                        MessageBox.Show("Selected COMEMITTER not found.");
//                        return;
//                    }
...
//                emitter.Name = string.IsNullOrWhiteSpace(CommEmitterNameTextBox2.Text)
//                    ? "COMEMITTER1"
//                    : CommEmitterNameTextBox2.Text.Trim();

//                emitter.PlatformType = PlatformType.LAND_STATIC;
//                emitter.ModeType = (CommEmitterModeComboBox2.SelectedItem as ComboBoxItem)?.Content?.ToString() ?? "FF";
//                emitter.PowerTransmitted = power;
//                emitter.StartFrequencyValue = frequency;
//                emitter.StopFrequencyValue = frequency;
//                emitter.Bandwidth = bandwidth;
...
//                emitter.PatternType = "DEFAULT";
//                emitter.ScanRate = scanRate;
//                emitter.AntennaType = string.IsNullOrWhiteSpace(CommEmitterAntennaTypeTextBox2.Text)
//                    ? "DEFAULT"
//                    : CommEmitterAntennaTypeTextBox2.Text.Trim();
//                emitter.Gain = gain;
//                emitter.Polarization = string.IsNullOrWhiteSpace(CommEmitterPolarizationTextBox2.Text)
//                    ? "VERTICAL"
//                    : CommEmitterPolarizationTextBox2.Text.Trim();
//                emitter.LineId = redLineId;
//                emitter.EmitterType = (CommEmitterEmitterTypeComboBox2.SelectedItem as ComboBoxItem)?.Content?.ToString() ?? "COMMUNICATION";
//                emitter.Type = EmitterKeyName.COMMEMITTER;
//                emitter.UpdatedOn = DateTime.Now;

//                db.SaveChanges();

//                _selectedCommEmitterId = emitter.Id;

//                MessageBox.Show(isUpdate
//                    ? "COMEMITTER updated successfully."
//                    : "COMEMITTER saved successfully.");

//                LoadScenario();
//                ShowCommEmitterPropertiesForm(emitter.Name);
//            }
//            catch (Exception ex)
//            {
//                string fullError = ex.Message;
...
//                MessageBox.Show(fullError, "Failed to save COMEMITTER");
//            }
//        }
...
//                double? power = null;
//                if (double.TryParse(RadarPowerTextBox2.Text, out double parsedPower))
//                    power = parsedPower;

//                double? frequency = null;
//                if (double.TryParse(RadarFrequencyTextBox2.Text, out double parsedFrequency))
//                    frequency = parsedFrequency;

//                double? bandwidth = null;
//                if (double.TryParse(RadarBandwidthTextBox2.Text, out double parsedBandwidth))
//                    bandwidth = parsedBandwidth;

//                double? gain = null;
//                if (double.TryParse(RadarGainTextBox2.Text, out double parsedGain))
//                    gain = parsedGain;

//                double? scanRate = null;
//                if (double.TryParse(RadarScanRateTextBox2.Text, out double parsedScanRate))
//                    scanRate = parsedScanRate;

//                Emitter emitter;
//                bool isUpdate = false;

//                if (_selectedRadarEmitterId.HasValue)
//                {
//                    emitter = db.Emitters.FirstOrDefault(x => x.Id == _selectedRadarEmitterId.Value);
//                    if (emitter == null)
//                    {
//                        MessageBox.Show("Selected RADAR not found.");
//                        return;
//                    }
...
//                emitter.Name = string.IsNullOrWhiteSpace(RadarNameTextBox2.Text)
//                    ? "RADAR1"
//                    : RadarNameTextBox2.Text.Trim();

//                emitter.PlatformType = PlatformType.LAND_STATIC;
//                emitter.ModeType = (RadarModeComboBox2.SelectedItem as ComboBoxItem)?.Content?.ToString() ?? "TRACK";
//                emitter.PowerTransmitted = power;
//                emitter.StartFrequencyValue = frequency;
//                emitter.StopFrequencyValue = frequency;
//                emitter.Bandwidth = bandwidth;
...
//                emitter.PatternType = "DEFAULT";
//                emitter.ScanRate = scanRate;
//                emitter.AntennaType = string.IsNullOrWhiteSpace(RadarAntennaTypeTextBox2.Text)
//                    ? "DEFAULT"
//                    : RadarAntennaTypeTextBox2.Text.Trim();
//                emitter.Gain = gain;
//                emitter.Polarization = string.IsNullOrWhiteSpace(RadarPolarizationTextBox2.Text)
//                    ? "VERTICAL"
//                    : RadarPolarizationTextBox2.Text.Trim();
//                emitter.LineId = redLineId;
//                emitter.EmitterType = (RadarEmitterTypeComboBox2.SelectedItem as ComboBoxItem)?.Content?.ToString() ?? "RADAR";
//                emitter.Type = EmitterKeyName.RED_LINE_RADAR;
//                emitter.UpdatedOn = DateTime.Now;

//                db.SaveChanges();

//                _selectedRadarEmitterId = emitter.Id;

//                MessageBox.Show(isUpdate
//                    ? "RADAR updated successfully."
//                    : "RADAR saved successfully.");

//                LoadScenario();
//                ShowRadarPropertiesForm(emitter.Name);
//            }
//            catch (Exception ex)
//            {
//                string fullError = ex.Message;
...
//                MessageBox.Show(fullError, "Failed to save RADAR");
//            }
//        }
